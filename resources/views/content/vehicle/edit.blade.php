                            ...
                            <div class="col-md-9">
                                <select name="vehicle_category" class="form-control" required>
                                    @foreach ($vehicle_categories as $vehicle_category)
                                        <option value="{{$vehicle_category->id}}" @if($vehicle_category->id==$vehicle->vehicle_category_id) selected @endif>{{$vehicle_category->name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-9">
                                <select name="vehicle_model_id" class="form-control" required>
                                    @foreach ($vehicle_models as $vehicle_model)
                                        <option value="{{$vehicle_model->id}}" @if($vehicle_model->id==$vehicle->vehicle_category_id) selected @endif>{{$vehicle_model->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
