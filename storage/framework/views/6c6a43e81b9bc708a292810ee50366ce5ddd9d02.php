        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-options">
                    ...
                    <a href="<?php echo e(route('machine.create')); ?>" class="btn btn-primary btn-sm form_box">
                            ...
                            <?php $__currentLoopData = $machines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $machine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td>
                                    <div class="btn-list">
                                        ...
                                        <a href="<?php echo e(route('machine.edit',encrypt($machine->id))); ?>" class="btn btn-sm btn-primary form_box">
                                        ...
                                        <a href="<?php echo e(route('machine.delete',encrypt($machine->id))); ?>" class="btn  btn-sm btn-danger confirm_delete" data-id="<?php echo e($machine->id); ?>">
                                            ...
                                            <a href="<?php echo e(route('machine.show',encrypt($machine->id))); ?>" class="btn btn-sm btn-primary form_box">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/tyre_shopadmin/resources/views/content/machine/index.blade.php ENDPATH**/ ?>