                    ...
                    <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-40p border-bottom-0">Approved by Admin </th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php if($vehicle->approved==0): ?>NO  <?php else: ?> YES <?php endif; ?></td>
                                <td>
                                    <div class="btn-list">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/carwash_shopadmin/resources/views/content/vehicle/index.blade.php ENDPATH**/ ?>