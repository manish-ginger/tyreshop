        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-options">
                    ...
                    <a href="<?php echo e(route('coupon.create')); ?>" class="btn btn-primary btn-sm">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-list">
                                        ...
                                        <a href="<?php echo e(route('coupon.edit',encrypt($coupon->id))); ?>" class="btn btn-sm btn-primary">
                                            <span class="fe fe-edit"> </span>
                                        </a>
                                        <?php endif; ?>
                                        <?php if(CheckAdminLogged::role_control('coupon.delete')==1): ?>
                                        <a href="<?php echo e(route('coupon.delete',encrypt($coupon->id))); ?>" class="btn  btn-sm btn-danger confirm_delete">
                                            <span class="fe fe-trash-2"> </span>
                                        </a>
                                            <?php endif; ?>
                                            <?php if(CheckAdminLogged::role_control('coupon.show')==1): ?>
                                        <a href="<?php echo e(route('coupon.show',encrypt($coupon->id))); ?>" class="btn btn-sm btn-primary">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/carwash_shopadmin/resources/views/content/coupon/index.blade.php ENDPATH**/ ?>