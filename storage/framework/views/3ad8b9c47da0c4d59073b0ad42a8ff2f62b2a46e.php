        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-options">
                    ...
                    <a href="<?php echo e(route('package.create')); ?>" class="btn btn-primary btn-sm form_box">
                            ...
                            <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td>
                                    <div class="btn-list">
                                        ...
                                        <a href="<?php echo e(route('package.edit',encrypt($package->id))); ?>" class="btn btn-sm btn-primary form_box">
                                        ...
                                        <a href="<?php echo e(route('package.show',encrypt($package->id))); ?>" class="btn btn-sm btn-primary form_box">
