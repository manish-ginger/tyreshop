                ...
                <div class="app-sidebar">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="<?php echo e(route('vehicle')); ?>"><i class="side-menu__icon fe fe-grid"></i><span class="side-menu__label">Vehicles</span></a>
                            </li>
                            <li class="slide">
            ...
            <!--app-sidebar-->
<?php /**PATH /opt/lampp/htdocs/carwashf/resources/views/layouts/components/app-sidebar.blade.php ENDPATH**/ ?>