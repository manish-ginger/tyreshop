                    ...
                    <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-40p border-bottom-0">Vehicle Model</th>
                                <th class="wd-40p border-bottom-0">Vehicle Category</th>
                                <th class="wd-40p border-bottom-0">Vehicle Brand</th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/carwash_superadmin/resources/views/content/vehiclemodel/index.blade.php ENDPATH**/ ?>