    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <form action="<?php echo e(route('machine.update')); ?>" method="post" accept-charset="utf-8"
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="title" class="form-control"
                                    value="<?php if(isset($machine->title)): ?> <?php echo e($machine->title); ?> <?php endif; ?>" required>
                                <input type="hidden" name="machineid"
                                    value="<?php if(isset($machine->id)): ?> <?php echo e(encrypt($machine->id)); ?> <?php endif; ?>">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 mb-4">
                                <textarea class="content" name="desc" placeholder="Description"><?php if(isset($machine->desc)): ?> <?php echo e($machine->desc); ?> <?php endif; ?></textarea>
                            </div>
                        </div>
                        <!--End Row-->
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="checkbox" name="approved" value="1" <?php if($machine->status == 1): ?> checked <?php endif; ?>>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/tyre_shopadmin/resources/views/content/machine/edit.blade.php ENDPATH**/ ?>