                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="card-title">Add New Vehicle Category</div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="name" class="form-control" placeholder="Vehicle Category Name"  required>
                                                </div>
                                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/carwash_superadmin/resources/views/content/vehiclecategory/create.blade.php ENDPATH**/ ?>