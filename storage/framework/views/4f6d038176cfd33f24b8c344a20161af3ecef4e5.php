...
<html lang="en" dir="ltr">
    ...
    <head>
        ...
        <meta name="description" content="Alpha Laboratories Qatar">
        <meta name="author" content="Alpha Laboratories Qatar">
        <meta name="keywords" content="Alpha Laboratories Qatar">

        <!-- title -->
        <title>Admin | Alpha Laboratories Qatar</title>
...
</script><?php /**PATH /opt/lampp/htdocs/carwash/resources/views/layouts/custom-app.blade.php ENDPATH**/ ?>