                ...
                <div class="app-sidebar">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="<?php echo e(route('vehicle')); ?>"><i class="side-menu__icon fe fe-grid"></i><span class="side-menu__label">Vehicle</span></a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="<?php echo e(route('washingtype')); ?>"><i class="side-menu__icon fe fe-droplet"></i><span class="side-menu__label">Washing Type</span></a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="<?php echo e(route('package')); ?>"><i class="side-menu__icon fe fe-briefcase"></i><span class="side-menu__label">Packages</span></a>
                            </li>
            ...
            <!--app-sidebar-->
<?php /**PATH /opt/lampp/htdocs/carwash/resources/views/layouts/components/app-sidebar.blade.php ENDPATH**/ ?>