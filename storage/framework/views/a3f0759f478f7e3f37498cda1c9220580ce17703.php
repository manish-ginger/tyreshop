        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-options">
                    <a href="<?php echo e(route('loyaltypoint.create')); ?>" class="btn btn-primary btn-sm form_box">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-list">
                                        ...
                                        <a href="<?php echo e(route('loyaltypoint.edit',encrypt($loyalty->id))); ?>" class="btn btn-sm btn-primary form_box">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/tyre_shopadmin/resources/views/content/loyaltypoint/index.blade.php ENDPATH**/ ?>