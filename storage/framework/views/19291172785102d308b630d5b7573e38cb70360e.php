                ...
                <form action="<?php echo e(route('vehiclecategory.update')); ?>" method="post" accept-charset="utf-8"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input class="" type="file" name="image" id="image_input" required>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/carwashf/resources/views/content/vehiclecategory/edit.blade.php ENDPATH**/ ?>