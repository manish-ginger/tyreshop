        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-options">
                    ...
                    <a href="<?php echo e(route('customervehicle.create')); ?>" class="btn btn-primary btn-sm form_box">
                            ...
                            <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td>
                                    <div class="btn-list">
                                        ...
                                        <a href="<?php echo e(route('customervehicle.edit',encrypt($row->id))); ?>" class="btn btn-sm btn-primary form_box">
                                            <span class="fe fe-edit"> </span>
                                        </a>
                                        <?php endif; ?>
                                            <?php if(CheckAdminLogged::role_control('customervehicle.delete')==1): ?>
                                        <a href="<?php echo e(route('customervehicle.delete',encrypt($row->id))); ?>" class="btn  btn-sm btn-danger confirm_delete" data-id="<?php echo e($row->id); ?>">
