        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-options">
                    <a href="<?php echo e(route('vehiclebrand.create')); ?>" class="btn btn-primary btn-sm form_box">
                            ...
                            <?php $__currentLoopData = $vehicleBrands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehiclebrand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td>
                                    <?php if($vehiclebrand->image!=''): ?>
                                        <img src="<?php echo e('/' . $vehiclebrand->image); ?>" style="max-height: 100px; max-width: 100px;" >
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <div class="btn-list">
                                        <a href="<?php echo e(route('vehiclebrand.edit',encrypt($vehiclebrand->id))); ?>" class="btn btn-sm btn-primary form_box">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/tyre_superadmin/resources/views/content/vehiclebrand/index.blade.php ENDPATH**/ ?>