        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Update Vehicle Brand</div>
                </div>
                <form action="<?php echo e(route('vehiclebrand.update')); ?>" method="post" accept-charset="utf-8"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            ?>
                            <label class="col-md-3 form-label mb-4">Shops :</label>

                            <div class="col-md-9 mb-4">
                                <?php $__currentLoopData = $shops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label><input type="checkbox" name="shops[]" value="<?php echo e($shop->id); ?>" <?php if(in_array($shop->id,$shops_db)): ?> checked <?php endif; ?>><?php echo e($shop->name); ?></label>
                                    <hr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                    ...
                    <div class="card-footer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 text-end">
                                ...
                                <button class="btn btn-success">Update Vehicle Brand</button>
                            </div>
                        </div>
                        <!--End Row-->
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/carwash_superadmin/resources/views/content/vehiclebrand/edit.blade.php ENDPATH**/ ?>