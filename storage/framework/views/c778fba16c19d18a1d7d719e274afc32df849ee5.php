        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-options">
                    ...
                    <a href="<?php echo e(route('customer.create')); ?>" class="btn btn-primary btn-sm form_box">
            ...
            <div class="card-body">
                <div class="table-responsive">
                  ...
                  `                      <a href="<?php echo e(route('customer.edit',encrypt($customer->id))); ?>" class="btn btn-sm btn-primary form_box">
                                        ...
                                        <a href="<?php echo e(route('customer.show',encrypt($customer->id))); ?>" class="btn btn-sm btn-primary form_box">
