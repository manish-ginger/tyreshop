                ...
                <form action="<?php echo e(route('shop.update')); ?>" method="post" accept-charset="utf-8"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="location" value="<?php if(isset($shop->detail->location)): ?> <?php echo e($shop->detail->location); ?> <?php endif; ?>" class="form-control" placeholder="Shop location">
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="owner" value="<?php if(isset($shop->detail->owner)): ?> <?php echo e($shop->detail->owner); ?> <?php endif; ?>" class="form-control" placeholder="Owner Contact">
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/carwash_shopadmin/resources/views/content/shop/edit.blade.php ENDPATH**/ ?>