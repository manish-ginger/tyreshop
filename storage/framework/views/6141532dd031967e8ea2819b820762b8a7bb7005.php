                    ...
                    <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
                        <tr>
                            <td style="padding:30px;background-color:#ffffff;">
                                ...
                                <h5 style="margin-top:0;margin-bottom:16px;font-size:18px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;"><?php echo e($details->content); ?> Details are given below.</h5>
                                <h5 style="margin-top:0;margin-bottom:16px;font-size:18px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;">Details are given below.</h5>
                            </td>
                        </tr>
                        <tr>
...
<?php /**PATH /opt/lampp/htdocs/carwash_shopadmin/resources/views/emails/reminder.blade.php ENDPATH**/ ?>