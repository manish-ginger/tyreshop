                ...
                <form action="<?php echo e(route('banner.update')); ?>" method="post" accept-charset="utf-8"
                    ...
                    <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <ul class="row col-md-12">
                                            ...
                                            <div class="float-left col-md-4">
                                                <img src="<?php echo e('/' . $banner->path); ?>" class="img-responsive col-md-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input class="" type="file" id="formFileMultiple" name="files" required>
                            </div>
                        </div>
                        <!--End Row-->
                        <hr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/carwashf/resources/views/content/banner/edit.blade.php ENDPATH**/ ?>