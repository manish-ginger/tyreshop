        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-options">
                    ...
                    <a href="<?php echo e(route('feature.create')); ?>" class="btn btn-primary btn-sm">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-list">
                                        ...
                                        <a href="<?php echo e(route('feature.edit',encrypt($feature->id))); ?>" class="btn btn-sm btn-primary">
                                            <span class="fe fe-edit"> </span>
                                        </a>
                                        <?php endif; ?>
                                        <?php if(CheckAdminLogged::role_control('feature.delete')==1): ?>
                                        <a href="<?php echo e(route('feature.delete',encrypt($feature->id))); ?>" class="btn  btn-sm btn-danger confirm_delete">
                                            <span class="fe fe-trash-2"> </span>
                                        </a>
                                            <?php endif; ?>
                                            <?php if(CheckAdminLogged::role_control('feature.show')==1): ?>
                                        <a href="<?php echo e(route('feature.show',encrypt($feature->id))); ?>" class="btn btn-sm btn-primary">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/carwash_shopadmin/resources/views/content/feature/index.blade.php ENDPATH**/ ?>