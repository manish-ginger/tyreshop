                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="licence" class="form-control" placeholder="Shop Name"  required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="location" class="form-control" placeholder="Shop Contact">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="contact" class="form-control" placeholder="Shop Contact">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="whatsapp" class="form-control" placeholder="Shop Name" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9 mb-4">
                                                    <input type="email" name="email" class="form-control" placeholder="Shop email" >
                                                </div>
                                            </div>
                                            <!--End Row-->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/carwashf/resources/views/content/shop/create.blade.php ENDPATH**/ ?>