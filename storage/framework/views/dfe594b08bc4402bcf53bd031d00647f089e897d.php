    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Loyalty List</h3>
                <div class="card-options">
                    <a href="<?php echo e(route('loyalty.create')); ?>" class="btn btn-primary btn-sm">
                    ...
                    <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-40p border-bottom-0">Loyalty Status</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($loyalty->name); ?></td>
                                <td><?php if($loyalty->status==0): ?>NO  <?php else: ?> YES <?php endif; ?></td>
                                <td>
                                    <div class="btn-list">
                                        <a href="<?php echo e(route('loyalty.edit',encrypt($loyalty->id))); ?>" class="btn btn-sm btn-primary">
                                            <span class="fe fe-edit"> </span>
                                        </a>
                                        <a href="<?php echo e(route('loyalty.delete',encrypt($loyalty->id))); ?>" class="btn  btn-sm btn-danger confirm_delete">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/carwash_shopadmin/resources/views/content/loyalty/index.blade.php ENDPATH**/ ?>