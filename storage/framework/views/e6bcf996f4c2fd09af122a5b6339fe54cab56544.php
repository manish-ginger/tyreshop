                                            ...
                                            foreach ($permission_data as $key => $value)
                                                {
                                                    ...
                                                    if($key=="'packagerecord'"){
                                                        $customer_packages=$value;
                                                    }
                                                    if($key=="'loyaltypoint'"){
                                                        $loyalty_rewards=$value;
                                                    }
                                                    if($key=="'notification'"){
                                                        $notifications=$value;
                                                    }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/carwash_superadmin/resources/views/content/role/show.blade.php ENDPATH**/ ?>