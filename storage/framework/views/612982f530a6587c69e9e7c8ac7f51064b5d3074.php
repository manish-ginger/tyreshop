...
<?php $__env->startSection('content'); ?>
    ...
    <div class="page-header">
        <h1 class="page-title">Vehicle Model</h1>
        <div>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Vehicle Model</a></li>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Add New Vehicle Model</div>
                </div>
                <form action="<?php echo e(route('vehiclemodel.store')); ?>" method="post"  accept-charset="utf-8" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            <label class="col-md-3 form-label">Vehicle Model Name :</label>
                            <div class="col-md-9">
                                <input type="text" name="name" class="form-control" placeholder="Vehicle Model Name"  required>
                            </div>
                        </div>
                    ...
                    <div class="card-footer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 text-end">
                                ...
                                <button class="btn btn-success">Add Vehicle Model</button> &nbsp; &nbsp;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/carwash_superadmin/resources/views/content/vehiclemodel/create.blade.php ENDPATH**/ ?>