            ...
            <div class="card">
                ...
                <form action="<?php echo e(route('coupon.update')); ?>" method="post" accept-charset="utf-8"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            <label class="col-md-3 form-label">Value(of percentage/amount) :</label>
                            <div class="col-md-9">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/carwash_shopadmin/resources/views/content/coupon/edit.blade.php ENDPATH**/ ?>