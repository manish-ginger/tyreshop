            ...
            <div class="card">
                ...
                <form action="<?php echo e(route('vehicle.update')); ?>" method="post" accept-charset="utf-8"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <select name="vehicle_brand_id" class="form-control"  required id="brand">
                                    <option disabled value="">Choose Vehicle brand</option>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <select name="vehicle_model_id" class="form-control"  required id="model">
                                    <option disabled value="">Choose Vehicle model</option>
                        ...
                        <div class="row mb-4">
                            <label class="col-md-3 form-label">Vehicle Approved :</label>
                            <div class="col-md-9">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/carwash_superadmin/resources/views/content/vehicle/edit.blade.php ENDPATH**/ ?>