                            ...
                            <div class="col-md-9">
                                <select name="status" class="form-control" required>
                                    <option selected disabled value="">Choose Service Status</option>
                                        ...
                                        <option value="1">Vehicle Received</option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/carwash_shopadmin/resources/views/content/servicerecord/create.blade.php ENDPATH**/ ?>