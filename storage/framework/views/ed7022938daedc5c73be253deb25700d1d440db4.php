        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-options">
                    <a href="<?php echo e(route('role.create')); ?>" class="btn btn-primary btn-sm form_box">
                    ...
                    <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td>
                                    <div class="btn-list">
                                        <a href="<?php echo e(route('role.edit',encrypt($role->id))); ?>" class="btn btn-sm btn-primary form_box">
                                            <span class="fe fe-edit"> </span>
                                        </a>
                                        <a href="<?php echo e(route('role.delete',encrypt($role->id))); ?>" class="btn  btn-sm btn-danger confirm_delete" data-id="<?php echo e($role->id); ?>">
                                            <span class="fe fe-trash-2"> </span>
                                        </a>
                                        <a href="<?php echo e(route('role.show',encrypt($role->id))); ?>" class="btn btn-sm btn-warning form_box">
