        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-options">
                    <a href="<?php echo e(route('vehiclecategory.create')); ?>" class="btn btn-primary btn-sm form_box">
                    ...
                    <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $vehicleCategorys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehiclecategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td>
                                    <div class="btn-list">
                                        <a href="<?php echo e(route('vehiclecategory.edit',encrypt($vehiclecategory->id))); ?>" class="btn btn-sm btn-primary form_box">
