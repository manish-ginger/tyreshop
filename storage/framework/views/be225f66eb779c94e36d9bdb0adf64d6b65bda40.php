...
<div class="page-header">
    <h1 class="page-title">Washing Type</h1>
    <div>
        <ol class="breadcrumb">
                    ...
                    <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-40p border-bottom-0">Washing Type</th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/carwash_superadmin/resources/views/content/brandshop/index.blade.php ENDPATH**/ ?>