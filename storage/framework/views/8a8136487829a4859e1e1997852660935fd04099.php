            ...
            <div class="card">
                ...
                <div class="card-body">
                    <?php if(count($shops)==0): ?>
                        <a href="<?php echo e(route('shop.create')); ?>" class="form_box">Create Shops to set notifications</a>
                    <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/tyre_sa/resources/views/content/notification/index.blade.php ENDPATH**/ ?>